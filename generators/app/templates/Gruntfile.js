...
module.exports = function (grunt) {
  ...
  grunt.registerTask('serve', function () {
    grunt.task.run(['clean:dist', 'jshint', 'uglify', 'pug', 'sass', 'copy', 'clean-dist', 'connect', 'open', 'watch']);
  });
  grunt.registerTask('build', function () {
    grunt.task.run(['clean:dist', 'jshint', 'uglify', 'pug', 'sass', 'copy', 'clean-dist']);
  });
  grunt.registerTask('rebuild', function () {
    grunt.task.run(['clean:dist', 'uglify', 'pug', 'sass', 'copy', 'clean-dist']);
  });
};
